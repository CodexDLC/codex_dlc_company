...
class SiteSettings(models.Model):
    ...
    # --- General ---
    company_name = models.CharField(_("Company Name"), max_length=255, default="codex_dlc_company")
    ...
    email = models.EmailField(_("Email"), default="info@codex_dlc_company.com")
